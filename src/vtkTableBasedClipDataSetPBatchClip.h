...
// https://gitlab.kitware.com/vtk/vtk/-/blob/3981e28e4caac58160f930d7194ab0fccad512ed/Filters/General/vtkTableBasedClipDataSet.h
/**
 * @class   vtkTableBasedClipDataSetPBatchClip
 * @brief   Clip any dataset with a user-specified
 *  implicit function or an input scalar point data array.
 *
 *
 *  vtkTableBasedClipDataSetPBatchClip is a filter that clips any type of dataset using
 ...
 *  with most grids. It is worth mentioning that vtkTableBasedClipDataSetPBatchClip is
 ...
 *
 * @warning
 *  vtkTableBasedClipDataSetPBatchClip makes use of a hash table (that is provided by class
...
#ifndef vtkTableBasedClipDataSetPBatchClip_h
#define vtkTableBasedClipDataSetPBatchClip_h
...
class VTKFILTERSGENERAL_EXPORT vtkTableBasedClipDataSetPBatchClip : public vtkUnstructuredGridAlgorithm
{
public:
  vtkTypeMacro(vtkTableBasedClipDataSetPBatchClip, vtkUnstructuredGridAlgorithm);
   ...
   */
  static vtkTableBasedClipDataSetPBatchClip* New();
...
protected:
  vtkTableBasedClipDataSetPBatchClip(vtkImplicitFunction* cf = nullptr);
  ~vtkTableBasedClipDataSetPBatchClip() override;
...
private:
  vtkTableBasedClipDataSetPBatchClip(const vtkTableBasedClipDataSetPBatchClip&) = delete;
  void operator=(const vtkTableBasedClipDataSetPBatchClip&) = delete;
};
