/*=========================================================================
  ...
  Module:    vtkTableBasedClipDataSetSClip.cxx
...
=========================================================================*/
// https://gitlab.kitware.com/vtk/vtk/-/blob/0bdef360b84d08415f6f31db54593e1dca172e11/Filters/General/vtkTableBasedClipDataSet.cxx
...
#include "vtkTableBasedClipCasesSClip.cxx"

vtkStandardNewMacro(vtkTableBasedClipDataSetSClip);
vtkCxxSetObjectMacro(vtkTableBasedClipDataSetSClip, ClipFunction, vtkImplicitFunction);
...
vtkTableBasedClipDataSetSClip::vtkTableBasedClipDataSetSClip(vtkImplicitFunction* cf)
{
  ...
  this->InternalProgressObserver->SetCallback(
    &vtkTableBasedClipDataSetSClip::InternalProgressCallbackFunction);
...
//------------------------------------------------------------------------------
vtkTableBasedClipDataSetSClip::~vtkTableBasedClipDataSetSClip()
{
  if (this->Locator)
  {
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::InternalProgressCallbackFunction(
  vtkObject* arg, unsigned long, void* clientdata, void*)
{
  reinterpret_cast<vtkTableBasedClipDataSetSClip*>(clientdata)
    ->InternalProgressCallback(static_cast<vtkAlgorithm*>(arg));
}

//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::InternalProgressCallback(vtkAlgorithm* algorithm)
{
...
//------------------------------------------------------------------------------
vtkMTimeType vtkTableBasedClipDataSetSClip::GetMTime()
{
  vtkMTimeType time;
...
vtkUnstructuredGrid* vtkTableBasedClipDataSetSClip::GetClippedOutput()
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::SetLocator(vtkIncrementalPointLocator* locator)
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::CreateDefaultLocator()
{
  if (this->Locator == nullptr)
  {
...
//------------------------------------------------------------------------------
int vtkTableBasedClipDataSetSClip::FillInputPortInformation(int, vtkInformation* info)
{
...
//------------------------------------------------------------------------------
int vtkTableBasedClipDataSetSClip::RequestData(vtkInformation* vtkNotUsed(request),
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::ClipDataSet(
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::ClipImageData(
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::ClipPolyData(
  vtkDataSet* inputGrd, vtkDataArray* clipAray, double isoValue, vtkUnstructuredGrid* outputUG)
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::ClipRectilinearGridData(
  vtkDataSet* inputGrd, vtkDataArray* clipAray, double isoValue, vtkUnstructuredGrid* outputUG)
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::ClipStructuredGridData(
  vtkDataSet* inputGrd, vtkDataArray* clipAray, double isoValue, vtkUnstructuredGrid* outputUG)
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::ClipUnstructuredGridData(
  vtkDataSet* inputGrd, vtkDataArray* clipAray, double isoValue, vtkUnstructuredGrid* outputUG)
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetSClip::PrintSelf(ostream& os, vtkIndent indent)
{
