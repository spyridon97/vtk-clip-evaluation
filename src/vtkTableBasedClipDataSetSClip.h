/*=========================================================================
  ...
  Module:    vtkTableBasedClipDataSetSClip.h
...
=========================================================================*/
// https://gitlab.kitware.com/vtk/vtk/-/blob/0bdef360b84d08415f6f31db54593e1dca172e11/Filters/General/vtkTableBasedClipDataSet.h
...
/**
 * @class   vtkTableBasedClipDataSetSClipSClip
 * @brief   Clip any dataset with a user-specified
 *  implicit function or an input scalar point data array.
 *
 *
 *  vtkTableBasedClipDataSetSClip is a filter that clips any type of dataset using
 ...
 *  with most grids. It is worth mentioning that vtkTableBasedClipDataSetSClip is
 ...
 *
 * @warning
 *  vtkTableBasedClipDataSetSClip makes use of a hash table (that is provided by class
...
#ifndef vtkTableBasedClipDataSetSClip_h
#define vtkTableBasedClipDataSetSClip_h
...
class VTKFILTERSGENERAL_EXPORT vtkTableBasedClipDataSetSClip : public vtkUnstructuredGridAlgorithm
{
public:
  vtkTypeMacro(vtkTableBasedClipDataSetSClip, vtkUnstructuredGridAlgorithm);
   ...
   */
  static vtkTableBasedClipDataSetSClip* New();
...
protected:
  vtkTableBasedClipDataSetSClip(vtkImplicitFunction* cf = nullptr);
  ~vtkTableBasedClipDataSetSClip() override;
...
private:
  vtkTableBasedClipDataSetSClip(const vtkTableBasedClipDataSetSClip&) = delete;
  void operator=(const vtkTableBasedClipDataSetSClip&) = delete;
};
