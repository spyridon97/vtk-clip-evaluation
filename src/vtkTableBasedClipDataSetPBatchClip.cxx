...
// https://gitlab.kitware.com/vtk/vtk/-/blob/3981e28e4caac58160f930d7194ab0fccad512ed/Filters/General/vtkTableBasedClipDataSet.cxx
...
vtkObjectFactoryNewMacro(vtkTableBasedClipDataSetPBatchClip);
vtkCxxSetObjectMacro(vtkTableBasedClipDataSetPBatchClip, ClipFunction, vtkImplicitFunction);

//------------------------------------------------------------------------------
// Construct with user-specified implicit function; InsideOut turned off; value
// set to 0.0; and generate clip scalars turned off.
vtkTableBasedClipDataSetPBatchClip::vtkTableBasedClipDataSetPBatchClip(vtkImplicitFunction* cf)
{
  ...
  this->InternalProgressObserver->SetCallback(
    &vtkTableBasedClipDataSetPBatchClip::InternalProgressCallbackFunction);
...
//------------------------------------------------------------------------------
vtkTableBasedClipDataSetPBatchClip::~vtkTableBasedClipDataSetPBatchClip()
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetPBatchClip::InternalProgressCallbackFunction(
  vtkObject* arg, unsigned long, void* clientdata, void*)
{
  reinterpret_cast<vtkTableBasedClipDataSetPBatchClip*>(clientdata)
    ->InternalProgressCallback(static_cast<vtkAlgorithm*>(arg));
}

//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetPBatchClip::InternalProgressCallback(vtkAlgorithm* algorithm)
{
...
//------------------------------------------------------------------------------
vtkMTimeType vtkTableBasedClipDataSetPBatchClip::GetMTime()
{
  vtkMTimeType time;
...
vtkUnstructuredGrid* vtkTableBasedClipDataSetPBatchClip::GetClippedOutput()
{
...
//------------------------------------------------------------------------------
int vtkTableBasedClipDataSetPBatchClip::FillInputPortInformation(int, vtkInformation* info)
{
  info->Set(vtkAlgorithm::INPUT_REQUIRED_DATA_TYPE(), "vtkDataSet");
  return 1;
}
//------------------------------------------------------------------------------
int vtkTableBasedClipDataSetPBatchClip::RequestData(vtkInformation* vtkNotUsed(request),
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetPBatchClip::SetLocator(vtkIncrementalPointLocator* locator)
{
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetPBatchClip::ClipDataSet(vtkDataSet* pDataSet, vtkUnstructuredGrid* outputUG)
{
...
struct EvaluatePoints
{
  ...
  vtkTableBasedClipDataSetPBatchClip* Filter;
...
struct ExtractCells
{
  ...
  ExtractCells(TGrid* input, vtkAOSDataArrayTemplate<TInputIdType>* pointsMap,
    ...
    vtkIdType numberOfCentroids, vtkTableBasedClipDataSetPBatchClip* filter)
    : Input(input)
    , PointsMap(pointsMap)
    , CellsCase(cellsCase)
...
//-----------------------------------------------------------------------------
template <typename TGrid, typename TInputIdType, bool TInsideOut>
vtkSmartPointer<vtkUnstructuredGrid> vtkTableBasedClipDataSetPBatchClip::ClipTDataSet(
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetPBatchClip::ClipPolyData(vtkPolyData* inputGrid,
...
void vtkTableBasedClipDataSetPBatchClip::ClipTDataSet(TGrid* inputGrid, vtkImplicitFunction* implicitFunction,
...
//------------------------------------------------------------------------------
void vtkTableBasedClipDataSetPBatchClip::PrintSelf(ostream& os, vtkIndent indent)
{
